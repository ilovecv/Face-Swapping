function morphed_im = morph_tps_wrapper(image1, image2, image1_pts, image2_pts, warp_frac, dissolve_frac, verbose)
...
% im1 = imread(image1);
% im2 = imread(image2);
% im1_pts = load(image1_pts);
% im2_pts = load(image2_pts);
% im1 = imread('./data/aaronm.jpg');
% im2 = imread('./data/addisond.jpg');
% im1_pts = load('./data/aaronm.txt');
% im2_pts = load('./data/addisond.txt');
im1 = imread('./data/3_resize.jpg');
im2 = imread('./data/4.jpg');
im1_pts = load('./data/3_resize_fpp.txt');
im2_pts = load('./data/4_fpp.txt');
